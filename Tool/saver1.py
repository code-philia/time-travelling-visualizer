...
from singleVis.projector import TrustVisProjector
...
parser.add_argument('--content_path', type=str,default="/home/timeTravelling/guorui/git_space/DataDemo/case_study_mnist_backdoor")
...
# Define Projector
projector = TrustVisProjector(vis_model=model, content_path=CONTENT_PATH, vis_model_name=VIS_MODEL_NAME, device=DEVICE)
...
for i in range(EPOCH_START, EPOCH_END+1, EPOCH_PERIOD):
    ...
    emb = projector.batch_project(i,all_data)
