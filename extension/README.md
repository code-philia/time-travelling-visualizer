# time-travelling-visualizer README

This is the README for your extension "time-travelling-visualizer". After writing up a brief description, we recommend including the following sections.

All files were firstly generated by `yo code`.

In `Run and Debug` view run the option `Run Extension` to run this extension.

This demo shows its feature in 2 ways:
